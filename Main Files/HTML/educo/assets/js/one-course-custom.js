(function($) {
    ...
    jQuery(document).ready(function($) {
        ...
        $('.on_image').on("click", function() {
            $('.ed_event_wrapper_item_img').html('<img src="../assets/images/default/slider/sec1_s5.jpg" alt="item1" class="img-responsive">');
            $('.on_image').hide();
            $('.on_map').show();
        });
        ...
        jQuery(function($) {
            ...
            $('.ed_video_section .ed_img_overlay a i').click(function(e) {
                e.preventDefault();
