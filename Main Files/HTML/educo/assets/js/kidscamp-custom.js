(function($) {
    ...
    jQuery(document).ready(function($) {
        ...
        $('.on_image').on("click", function() {
            $('.ed_event_wrapper_item_img').html('<img src="../assets/images/kidscamp/slider/crs12.jpg" alt="item1" class="img-responsive">');
            $('.on_image').hide();
            $('.on_map').show();
        });
        ...
        if (w <= 1199) {
            ...
            $(".main-menu .sub-menu > li").on('click', function(e) {
                $('.main-menu .sub-menu > li').not($(this)).closest('li').find('.sub-menu').slideUp();
                $('.main-menu .sub-menu > li').not($(this)).closest('li').removeClass('open');
                $(this).closest('li').find('.sub-menu').slideToggle();
                $(this).toggleClass("open");
            });
        }
